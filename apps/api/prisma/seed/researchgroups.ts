...
export async function SeedResearchGroups(prisma: PrismaClient) {
  const reseachGroups1 = {
    ...
    description:
      'O Recommender Systems Research Group - RecSys é um grupo criado em 2013 que investiga e desenvolve pesquisa científica de alto impacto na área de Sistemas de Recomendação.',
