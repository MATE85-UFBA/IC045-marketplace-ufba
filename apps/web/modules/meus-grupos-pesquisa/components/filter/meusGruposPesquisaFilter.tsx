...
const MeusGruposPesquisaFilter = ({ handleSearch, setOrder, order }: MeusGruposPesquisaFilterProps) => {
  return (
    <div className="flex flex-col sm:flex-row gap-2">
      <div className="flex gap-2 w-full">
        <Input className="bg-white px-4 h-12" placeholder="Buscar" onKeyDown={(e)=>{
